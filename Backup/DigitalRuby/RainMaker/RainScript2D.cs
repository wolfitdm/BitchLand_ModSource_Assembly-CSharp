...
public class RainScript2D : BaseRainScript
{
  ...
  private readonly ParticleSystem.Particle[] particles = new ParticleSystem.Particle[2048 /*0x0800*/];
  ...
  protected override float RainFallEmissionRate() => this.initialEmissionRain * this.RainIntensity;
