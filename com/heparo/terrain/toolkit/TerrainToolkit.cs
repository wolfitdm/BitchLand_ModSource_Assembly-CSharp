...
public class TerrainToolkit : MonoBehaviour
{
  ...
  public int voronoiCells = 16 /*0x10*/;
  ...
  public void addPresets()
  {
    ...
    this.voronoiPresets.Add((object) new TerrainToolkit.voronoiPresetData("Scattered Peaks", TerrainToolkit.VoronoiType.Linear, 16 /*0x10*/, 8f, 0.5f, 1f));
    ...
    this.voronoiPresets.Add((object) new TerrainToolkit.voronoiPresetData("Jagged Mountains", TerrainToolkit.VoronoiType.Linear, 32 /*0x20*/, 32f, 0.5f, 1f));
