  ...
  public void Start()
  {
    ...
    else if ((UnityEngine.Object) this.PersonGenerated == (UnityEngine.Object) null)
    {
      ...
      if (this.SpawnAnyGender && this.AlwaysDefinedGenderIfPossible)
      {
        ...
        if (this.DEBUG_GenderMix)
        {
          Debug.LogError((object) (this.DEBUG_LogID + " _genderSettings " + num.ToString()));
          Debug.LogError((object) (this.DEBUG_LogID + " (_genderSettings != 2 && _genderSettings != 1) " + (num != 2 && num != 1).ToString()));
        }
        if (num != 2 && num != 1)
        {
