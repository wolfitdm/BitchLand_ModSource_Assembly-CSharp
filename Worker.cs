...
public class Worker : BaseType
{
    ...
    RandomNPCHere commingFrom = null)
  {
    if (addClothing)
    {
      ...
      GameObject prefabsWeapon = this.Prefabs_Weapons[Random.Range(0, this.Prefabs_Weapons.Count)];
      if ((Object) prefabsWeapon != (Object) null)
      {
        GameObject weapon = Object.Instantiate<GameObject>(prefabsWeapon);
    ...
    person.DirtySkin = (double) Random.Range(0.0f, 1f) > 0.5;
  }
}
