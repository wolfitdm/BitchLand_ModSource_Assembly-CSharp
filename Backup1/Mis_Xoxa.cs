...
public class Mis_Xoxa : Mission
{
  ...
  public void Chat_Xoxa2()
  {
    ...
    _gameplay.AddChatOption("What's your name?", (Action) (() =>
    {
      ...
      _gameplay.DisplaySubtitle("My name is Xoxa", this.VoiceLines[64], new Action(person.ThisPersonInt.EndTheChat));
    }));
